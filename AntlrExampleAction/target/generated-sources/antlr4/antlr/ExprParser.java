...
public class ExprParser extends Parser {
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			do {
				...
				case 1:
					{
					setState(6); ((ProgContext)_localctx).x = decl();
				...
				case 2:
					{
					setState(9); ((ProgContext)_localctx).y = expr(0);
	...
	public final DeclContext decl() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(18); ((DeclContext)_localctx).name = match(ID);
			setState(19); match(T__2);
			setState(20); ((DeclContext)_localctx).type = match(INT_TYPE);
			setState(21); match(T__0);
			setState(22); ((DeclContext)_localctx).val = match(NUM);
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case ID:
				{
				setState(26); ((ExprContext)_localctx).id = match(ID);
			...
			case NUM:
				{
				setState(28); ((ExprContext)_localctx).n = match(NUM);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(34); ((ExprContext)_localctx).right = expr(5);
					...
					case 2:
						...
						setState(39); ((ExprContext)_localctx).right = expr(4);
	...
	public static final String _serializedATN =
		...
		"\2\2\63\2\16\3\2\2\2\4\24\3\2\2\2\6 \3\2\2\2\b\t\5\4\3\2\t\n\b\2\1\2\n"+
		"\17\3\2\2\2\13\f\5\6\4\2\f\r\b\2\1\2\r\17\3\2\2\2\16\b\3\2\2\2\16\13\3"+
		"\2\2\2\17\20\3\2\2\2\20\16\3\2\2\2\20\21\3\2\2\2\21\22\3\2\2\2\22\23\7"+
		"\2\2\3\23\3\3\2\2\2\24\25\7\7\2\2\25\26\7\4\2\2\26\27\7\t\2\2\27\30\7"+
		"\6\2\2\30\31\7\b\2\2\31\32\b\3\1\2\32\5\3\2\2\2\33\34\b\4\1\2\34\35\7"+
		"\7\2\2\35!\b\4\1\2\36\37\7\b\2\2\37!\b\4\1\2 \33\3\2\2\2 \36\3\2\2\2!"+
		".\3\2\2\2\"#\f\6\2\2#$\7\3\2\2$%\5\6\4\7%&\b\4\1\2&-\3\2\2\2\'(\f\5\2"+
		"\2()\7\5\2\2)*\5\6\4\6*+\b\4\1\2+-\3\2\2\2,\"\3\2\2\2,\'\3\2\2\2-\60\3"+
